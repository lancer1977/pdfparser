# pdfparser portfolio roadmap

## 90-day evidence snapshot
- Commits (90 days): 7
- Files changed (90 days): 20
- Last signal: c3a6921 (4 days ago)
- Top modified areas: docs(8);00_agile(6);watch.sh(1);stack.yml(1);README.md(1);Dockerfile(1)
- Notes: clean_at_scan
